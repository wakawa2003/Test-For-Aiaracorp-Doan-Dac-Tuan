...
namespace VolFx
{
    ...
    public sealed class VhsVol : VolumeComponent, IPostProcessComponent
    {
        ...
        [Header("Scanlines")]
        [InspectorName("Count")]
        public NoInterpClampedFloatParameter _sl_count     = new NoInterpClampedFloatParameter(.7f, .0f, 1f);
        [InspectorName("Intensity")]
        public ClampedFloatParameter         _sl_intensity = new ClampedFloatParameter(0f, .0f, 1f);
        [InspectorName("Move")]
        public ClampedFloatParameter         _sl_move      = new ClampedFloatParameter(0f, .0f, 1f);
        [InspectorName("Flicker")] [HideInInspector]
        public ClampedFloatParameter         _sl_flicker   = new ClampedFloatParameter(0f, .0f, 1f);
#endif
