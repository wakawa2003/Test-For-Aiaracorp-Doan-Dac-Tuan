...
namespace TrailsFX {
	...
	public partial class TrailEffectProfile : ScriptableObject {
		...
		public void Load (TrailEffect effect) {
			...
			effect.animationStateNormalizedStart = animationStateNormalizedStart;
			effect.animationStateNormalizedEnd = animationStateNormalizedEnd;
		...
		public void Save (TrailEffect effect) {
			...
			animationStateNormalizedStart = effect.animationStateNormalizedStart;
			animationStateNormalizedEnd = effect.animationStateNormalizedEnd;
