...
namespace TrailsFX {
    ...
    public class TrailEffectProfileEditor : Editor {
        ...
        SerializedProperty useLastAnimationState, maxBatches, meshPoolSize, interpolate, animationStates, animationStateNormalizedStart, animationStateNormalizedEnd;
