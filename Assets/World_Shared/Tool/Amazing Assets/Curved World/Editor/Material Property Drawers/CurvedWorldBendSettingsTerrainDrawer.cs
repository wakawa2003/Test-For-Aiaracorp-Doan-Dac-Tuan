...
namespace AmazingAssets.CurvedWorld.Editor
{
    public class CurvedWorldBendSettingsTerrainDrawer : MaterialPropertyDrawer
    {
        ...
        CurvedWorld.BendType shaderSupportedBendType;
        ...
        public override void OnGUI(Rect position, MaterialProperty prop, GUIContent label, MaterialEditor editor)
        {
            ...
            {
                bendType = (CurvedWorld.BendType)EditorGUILayout.Popup(" ", (int)bendType, Constants.bendTypesNamesForMenu);
            ...
            bendID = EditorGUILayout.IntSlider("Bend ID", bendID, 1, Constants.MAX_SUPPORTED_BEND_IDS);
        ...
        {
            string mainCGINCFilePath = EditorUtilities.GetGeneratedFilePath(updateBendType, updateBendID, Enum.Extension.cginc, false);
